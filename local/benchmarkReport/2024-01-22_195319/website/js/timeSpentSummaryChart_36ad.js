...
var chart_timeSpentSummaryChart_36ad = new Chart(document.getElementById('chart_timeSpentSummaryChart_36ad'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_36ad.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_36ad.resize();
});